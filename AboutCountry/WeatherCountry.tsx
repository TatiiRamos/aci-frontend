...
const WeatherCountry = () => {
  ...
  return (
    <div className="text-primary-blue text-left font-Montserrat">
      <HeroAboutCountry
        image="https://r2.awaqinternship.org/AboutColombia/clima-colombia.jpg"
        title={content?.aboutCountry[language]?.colombia.section2?.title}
      />
      <div>
        ...
        <div className="2xl:w-8/12 w-11/12 mx-auto mt-10">
          {content?.aboutCountry[language]?.colombia.section2?.paragraphs.map(
          ...
          <h2 className="text-center text-[24px] xl:text-[30px] 2xl:text-[30px] mt-10 mb-4 font-bold">
            {content?.aboutCountry[language]?.colombia.section2?.subtitle}
          </h2>
          {content?.aboutCountry[language]?.colombia.section2?.content.map(
