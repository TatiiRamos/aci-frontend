...
const InfoAYC = () => {
  ...
  return (
    ...
    <div className="flex flex-row xl:w-[70rem] 2xl:w-[70rem] mx-auto my-10 font-Montserrat">
      ...
      <section
        data-aos="fade-right"
        className="flex justify-top flex-col w-5/6 sm:w-auto md:w-auto lg:w-auto"
      >
        <div className="flex justify-center">
          <TitleMember
            title={content?.team[language].artAndCulture.teamName}
            description={content?.team[language].artAndCulture.description}
          />
        </div>
        <div className="flex justify-center flex-row flex-wrap">
          {content?.team[language].artAndCulture.team.map(
        ...
        <div className="flex justify-end items-end mr-4 sm:mt-14 md:mt-14">
          <BtnGoBackPrograms />
        </div>
      </section>
    </div>
