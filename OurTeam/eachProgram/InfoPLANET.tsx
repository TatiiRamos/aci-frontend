...
const InfoPLANET = () => {
  ...
  return (
    ...
    <div className="flex xl:w-[70rem] 2xl:w-[70rem] mx-auto my-10 flex-row font-Montserrat">
      <section>
        <ProgramsBar />
      </section>
      <section
      ...
      >
        <div className="flex justify-center">
          <TitleMember
            title={content?.team[language].planet.teamName}
            description={content?.team[language].planet.description}
          />
        </div>
        <div className="flex justify-center flex-row flex-wrap">
          {content?.team[language].planet.team.map(
