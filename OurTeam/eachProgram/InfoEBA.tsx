    ...
    <div className="flex flex-row xl:w-[70rem] 2xl:w-[70rem] mx-auto my-10 font-Montserrat">
      ...
      >
        <div className="flex justify-center">
          <TitleMember
            title={content?.team[language].bioStationAndes.teamName}
            description={content?.team[language].bioStationAndes.description}
          />
        </div>
        <div className="flex justify-center flex-row flex-wrap">
          {content?.team[language].bioStationAndes.team.map(
