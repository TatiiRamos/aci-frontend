...
import InfoMenuEBA from '../../components/InternshipACI/InfoMenuEBA'
...
const InternshipEBA: React.FC = () => {
  ...
  return (
    <section className="min-w-[340px]">
      <HeroNewInternships
        title={content?.newInternships[language].tituloEBA}
        subtitle={content?.newInternships[language].subTituloEBA}
      ...
      {selectedOption === 'opcion5' ? (
        <Prácticas
          ...
          title={content?.newInternships[language].tituloEBA}
          Info1={
            content?.newInternships[language].internship3.seccion5.practicaInfo1
          }
          Info2={
            content?.newInternships[language].internship3.seccion5.practicaInfo2
          }
          btn={content?.newInternships[language].btnReservar}
        />
      ) : (
      ...
      >
        ...
        />
        <InfoMenuEBA option={selectedOption} />
      </div>
      <InfoInternships />
      <CallToAction />
    </section>
